...
-(void)addLineWithType:(BMLineTypeCustom)type color:(UIColor *)color position:(BMLinePostionCustom)position
{
    switch (type) {
        case BMLineTypeCustomDefault:
        {
            ...
            NSMutableDictionary *dic=[objc_getAssociatedObject(self, (__bridge const void *)(kBMLineStoreKey)) mutableCopy];
            ...
            objc_setAssociatedObject(self, (__bridge const void *)(kBMLineStoreKey), dic, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
-(void)removeAllLines
{
    ...
    objc_setAssociatedObject(self, (__bridge const void *)(kBMLineStoreKey), nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    return;
}
